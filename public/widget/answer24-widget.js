  ...
  async function sendMessage(message, options = {}, pageContext = null) {
    ...
    try {
      ...
      const systemInstruction = `
        ...
        2. If the user asks about 'Answer24', explain that Schepenkring.nlis the technology company that provides this AI chat widget and automation tools for businesses.
      ...
      console.error("[Schepenkring.nlWidget] AI Error:", error);
      return {
        content:
