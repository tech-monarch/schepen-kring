# 🎉 Schepenkring.nlWidget v3.0.0 - Feature Upgrade Summary
...
Upgraded the Schepenkring.nlembeddable widget from basic chat functionality to a fully-featured, modern chat interface matching the internal React ChatWidget. The widget now includes a welcome screen, file uploads, voice input, and enhanced UX.
...
```html
<script
  src="https://yourdomain.com/widget/answer24-widget.js"
...
Successfully upgraded Schepenkring.nlembeddable widget to match the full feature set of the React ChatWidget. The widget now provides a modern, engaging chat experience with welcome screen, file uploads, voice input, and polished animations.
