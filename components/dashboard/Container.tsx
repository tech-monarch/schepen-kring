...
export default function CleanDashboardContainer({ children }: { children: React.ReactNode }) {
  const pathname = usePathname();

  const sidebarItems = [
    { title: "Overview", href: "/dashboard/admin", icon: BarChart3 },
    { title: "Fleet Management", href: "/dashboard/admin/yachts", icon: Anchor },
    { title: "Bidding Terminal", href: "/dashboard/admin/bids", icon: Hammer },
    { title: "Sailing Schedule", href: "/dashboard/admin/schedule", icon: Calendar },
