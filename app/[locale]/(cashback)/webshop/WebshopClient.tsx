...
import { Search, Tag, ShoppingBag, X, Check, Loader2, Mail, ArrowRight, Users, Sparkles, Calendar, Globe, Bell, Download, Ticket, ChevronLeft, ChevronRight, Clock } from "lucide-react";
...
const dummyDealsForWebshops = [
  {
    ...
    "long_description": "Bol.com is de grootste webwinkel van Nederland en België met een assortiment van boeken tot elektronica.",
  ...
  },
  {
    ...
    "long_description": "Coolblue staat bekend om de beste klantenservice en een groot aanbod aan consumentenelektronica.",
  ...
  },
  {
    ...
    "long_description": "Bestel je dagelijkse boodschappen eenvoudig online bij Albert Heijn en laat ze thuisbezorgen.",
    "url": "https://www.ah.nl",
    "available_days": ["1", "2", "3", "4", "5", "6", "7"]
  },
  {
    ...
    "long_description": "Zalando biedt een enorme collectie kleding, schoenen en accessoires van topmerken.",
  ...
  },
  {
    ...
    "long_description": "Bij MediaMarkt vind je alles op het gebied van multimedia, witgoed en gadgets.",
  ...
  },
  {
    ...
    "long_description": "Wehkamp is een van de oudste en meest vertrouwde online warenhuizen in Nederland.",
  ...
  },
  {
    ...
    "long_description": "Plan je volgende reis en verdien beloningen op elke overnachting via Booking.com.",
  ...
  },
  {
    ...
    "long_description": "Van rookworst tot handdoeken, bij HEMA vind je oer-Hollandse kwaliteit voor een goede prijs.",
  ...
  },
  {
    ...
    "long_description": "Shop de nieuwste trends voor dames, heren en kinderen bij H&M Nederland.",
  ...
  },
  {
    ...
    "long_description": "Of je nu zin hebt in pizza, sushi of burgers, Thuisbezorgd brengt het bij je aan de deur.",
  ...
  },
  {
    ...
    "long_description": "Ontdek kleding die bij jouw stijl past met een unieke gepersonaliseerde shopervaring.",
  ...
  },
  {
    ...
    "long_description": "Hoogwaardige huishoudelijke apparatuur en multimedia tegen scherpe prijzen.",
  ...
  },
  {
    ...
    "long_description": "Bestel je Jumbo boodschappen online en haal ze op bij een Pick Up Point of laat ze thuisbezorgen.",
  ...
  },
  {
    ...
    "long_description": "Transformeer je dagelijkse routines in betekenisvolle momenten met Rituals.",
  ...
  },
  {
    ...
    "long_description": "Vind de beste merken parfum, make-up en huidverzorging bij Parfumerie Douglas.",
  ...
  },
  {
    ...
    "long_description": "Alles voor bouwen, verbouwen en inrichten vind je online bij GAMMA.",
  ...
  },
  {
    ...
    "long_description": "Combineer klussen met inrichten bij Karwei voor een stijlvol resultaat.",
  ...
  },
  {
    ...
    "long_description": "Bij Praxis vind je gereedschap, bouwmaterialen en inspiratie voor elke klus.",
  ...
  },
  {
    ...
    "long_description": "Luxe merken, exclusieve mode en hoogwaardige woonaccessoires bij de Bijenkorf.",
  ...
  },
  {
    ...
    "long_description": "Bestel direct bij Nike voor de nieuwste sneakers, hardloopkleding en sportgear.",
  ...
  },
  {
    ...
    "long_description": "Ontdek de nieuwste collecties van Adidas Originals en performance sportkleding.",
  ...
  },
  {
    ...
    "long_description": "Decathlon maakt sport toegankelijk met kwalitatieve en betaalbare sportuitrusting.",
  ...
  },
  {
    ...
    "long_description": "Miljoenen producten tegen zeer lage prijzen direct uit China verzonden.",
  ...
  },
  {
    ...
    "long_description": "Amazon Nederland biedt alles van elektronica en boeken tot huishoudelijke artikelen.",
  ...
  },
  {
    ...
    "long_description": "Shop dagelijks nieuwe deals van topmerken in de exclusieve shopping club van Zalando.",
  ...
  },
  {
    ...
    "long_description": "Ontvang een exclusieve beloning bij het afsluiten van een nieuw energiecontract.",
  ...
  },
  {
    ...
    "long_description": "Boek je vlucht bij Transavia en geniet van een zorgeloze vakantie tegen een lage prijs.",
  ...
  },
  {
    ...
    "long_description": "De voordeligste drogisterij voor al je verzorging, babyartikelen en meer.",
  ...
  },
  {
    ...
    "long_description": "Deskundig advies en een ruim assortiment aan beauty- en gezondheidsproducten.",
  ...
  },
  {
    ...
    "long_description": "Shop het volledige assortiment meubels en woonaccessoires van IKEA online.",
  ...
  },
  {
    ...
    "long_description": "Vind alles voor je interieur, van banken tot gordijnen, bij Leen Bakker.",
  ...
  },
  {
    ...
    "long_description": "De laagste prijs in vloeren, gordijnen en leuke woonaccessoires.",
  ...
  },
  {
    ...
    "long_description": "Shop outdoor kleding, kampeerartikelen en reisaccessoires in de ANWB webwinkel.",
  ...
  },
  {
    ...
    "long_description": "Boek je zonvakantie naar Turkije, Griekenland of Curaçao voordelig bij Corendon.",
  ...
  },
  {
    ...
    "long_description": "Van all-inclusive resorts tot verre rondreizen, TUI heeft het allemaal.",
  ...
  },
  {
    ...
    "long_description": "Vind de perfecte schoenen en kleding bij de grootste schoenenspecialist van Nederland.",
  ...
  },
  {
    ...
    "long_description": "Modieuze en betaalbare schoenen voor dames, heren en kinderen bij VanHaren.",
  ...
  },
  {
    ...
    "long_description": "De leukste schoenen en kleding voor de laagste prijs vind je bij Bristol.",
  ...
  },
  {
    ...
    "long_description": "De grootste speelgoedwinkel van Nederland met alle populaire merken zoals LEGO en Playmobil.",
  ...
  },
  {
    ...
    "long_description": "Van keukenapparatuur tot schoonmaakartikelen, Blokker heeft alles in huis.",
  ...
  },
  {
    ...
    "long_description": "Specialist in vitaminen, supplementen en natuurlijke huidverzorging.",
  ...
  },
  {
    ...
    "long_description": "Shop duurzame en trendy collecties voor het hele gezin bij C&A.",
  ...
  },
  {
    ...
    "long_description": "Bonprix maakt mode toegankelijk voor iedereen met een ruim aanbod in alle maten.",
  ...
  },
  {
    ...
    "long_description": "Kook elke week iets nieuws en gezonds met de maaltijdboxen van HelloFresh.",
  ...
  },
  {
    ...
    "long_description": "Een webwarenhuis vol inspiratie en de mooiste merken op het gebied van wonen, koken en lifestyle.",
  ...
  },
  {
    ...
    "long_description": "Koop je tickets voor de Efteling online en vermijd de wachtrij bij de kassa.",
  ...
  },
  {
    ...
    "long_description": "Boek een vakantiehuisje op een van de vele Landal parken in binnen- en buitenland.",
  ...
  },
  {
    ...
    "long_description": "Alles voor je kampeeravontuur, van tenten tot wandelschoenen, vind je bij Vrijbuiter.",
  ...
  },
  {
    ...
    "long_description": "Specialist in boxsprings, matrassen en beddengoed van hoge kwaliteit.",
  ...
  },
  {
    ...
    "long_description": "Marktleider in sportvoeding, supplementen en fitnessaccessoires.",
...
useEffect(() => {
  ...
  const filteredItems = useMemo(() => {
    ...
    const baseList = activeMainTab === "webshops" ? dummyDealsForWebshops : deals;
                ...
                <div className="lg:sticky lg:top-10 h-fit">
                  <div className="bg-blue-600 rounded-[2rem] p-8 text-white shadow-2xl shadow-blue-200 space-y-6">
                    <div className="space-y-1">
                      ...
                      <p className="text-4xl font-[1000]">{selectedItem.cashback}</p>
                    </div>
                    <p className="text-blue-100 font-medium text-sm opacity-90 leading-relaxed">
                      Shop via de onderstaande knop om je cashback automatisch te registreren.
                    </p>
                    <a href={selectedItem.url} target="_blank" rel="noopener noreferrer"
                      ...
                      Bezoek Website <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                    </a>
                  </div>
                </div>
              </div>
