                    ...
                    {paymentStep === 3 && (
                      <div className="py-6 animate-in fade-in zoom-in-95 duration-500">
                        ...
                        <div className="text-center mb-8">
                          ...
                          <h4 className="text-3xl font-[1000] text-white tracking-tight leading-none mb-2">
                            You're Going!
                          </h4>
                          ...
                          <div className="p-8 pt-6">
                            <div className="grid grid-cols-2 gap-y-6 gap-x-4 mb-8">
                              ...
                              <div>
                                ...
                                <span className="text-green-500 font-black text-xs bg-green-50 px-2 py-1 rounded-md">
                                  READY
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                <button
                                  onClick={() =>
                                    handleCopyVoucherLink(selectedItem.id)
                                  }
                                  className="w-full bg-slate-100 text-slate-600 py-4 rounded-2xl font-bold text-xs flex items-center justify-center gap-2 hover:bg-slate-200 transition-all"
                                >
                                  <Link className="w-3.5 h-3.5" /> Copy Deal
                                  Link
                                </button>
                                <button
                                  onClick={() => setSelectedItem(null)}
