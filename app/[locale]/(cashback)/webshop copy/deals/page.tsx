  ...
  const handleBookDeal = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(
          "Saldo is afgeschreven, maar boeking kon niet worden opgeslagen. Neem contact op.",
        );
      }
    } catch (error: any) {
      console.error("Critical Booking Error:", error);
      toast.error(
        error.message || "Er is een fout opgetreden tijdens het boeken.",
      );
    } finally {
      setIsProcessing(false);
    }
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-blue-100 text-base mb-6 max-w-2xl mx-auto">
              Bekijk je gereserveerde deals en profiteer van exclusieve member
              voordelen bij onze partners.
            </p>
                ...
                >
                  ...
                  <div className="space-y-3 border-t border-slate-50 pt-6">
                    <div className="flex items-center gap-3 text-slate-500 text-xs font-bold">
                      ...
                      {new Date(deal.booking_date).toLocaleDateString("nl-NL", {
                        day: "numeric",
                        month: "long",
                        year: "numeric",
                      })}
        ...
        {selectedItem && (
                  ...
                  <>
                    ...
                    <div className="absolute top-10 left-1/2 -translate-x-1/2 z-20 flex gap-2">
                      {selectedItem.images.map((_: any, i: number) => (
                        <div
                          key={i}
                          className={`h-1.5 rounded-full transition-all duration-300 ${i === currentImageIndex ? "w-8 bg-blue-600" : "w-2 bg-white/40"}`}
                        />
                      ))}
                    </div>
                  </>
                  ...
                  <div className="max-w-7xl mx-auto w-full pointer-events-auto">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-xl text-white text-[10px] font-black uppercase tracking-widest transition-all"
                      >
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="flex flex-col items-center justify-center py-2">
                          <div className="flex items-baseline gap-2">
                            ...
                            <div className="flex items-baseline gap-0.5">
                              <span className="text-sm font-black text-green-300 drop-shadow-[0_0_8px_rgba(74,222,128,0.5)]">
                                €
                              </span>
          ...
          `}
                                  >
                                    {/* Day Name (Top) */}
                                    <span
                                      className={`text-[7px] font-black uppercase mb-0.5 tracking-tighter ${isSelected ? "text-blue-400" : "text-blue-300/40"}`}
                                    >
                                      {date.dayName}
                                    </span>
                                    ...
                                    {/* Day Number (Middle) */}
                                    <span
                                      className={`text-base font-black leading-none ${isSelected ? "text-slate-900" : "text-white"}`}
                                    >
                                      {date.dayNumber}
                                    </span>
                                    ...
                                    <span
                                      className={`text-[6px] font-bold uppercase mt-0.5 ${isSelected ? "text-slate-400" : "text-white/20"}`}
                                    >
                                      {date.monthName}
                                    </span>
                            ...
                            >
                              ...
                              <p className="text-blue-100 text-sm mb-6">
                                ...
                                <span className="text-white font-bold">
                                  €
                                  {(
                                    selectedItem.deal_price * peopleCount
                                  ).toFixed(2)}
                                </span>{" "}
                                from your wallet?
                              </p>
                          ...
                          <div className="pt-4 border-t border-white/10">
                            ...
                            <div className="pt-4 border-t border-white/10 space-y-2">
                              ...
                              <div className="flex justify-between items-center">
                                <p className="text-white font-bold">
                                  €{selectedItem.deal_price || 0} x{" "}
                                  {peopleCount}
                                </p>
                                <p className="text-white font-[1000] text-xl">
                                  €
                                  {(
                                    selectedItem.deal_price * peopleCount
                                  ).toFixed(2)}
                              ...
                              <div className="flex justify-between items-center pt-2 border-t border-white/5">
                                <p className="text-blue-100 text-[10px] uppercase font-black opacity-70">
                                  Your Wallet Balance:
                                </p>
                                <p
                                  className={`font-black ${walletBalance < selectedItem.deal_price * peopleCount ? "text-red-400" : "text-green-400"}`}
                                >
