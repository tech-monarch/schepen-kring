...
import { 
  ...
  BarChart3, Anchor, CheckSquare, Wifi, WifiOff,
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="bg-white border border-slate-100 p-8 text-center shadow-sm relative">
                  ...
                  <div className="mt-8">
                    ...
                    <p className="text-[9px] font-bold text-blue-500 uppercase tracking-widest mt-2">{user?.userType || "Staff Member"}</p>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 border-l-4 border-l-blue-500 p-6 flex gap-4">
                  ...
                  <p className="text-[9px] text-slate-500 leading-relaxed uppercase font-black tracking-tighter">
                    Identity verification is active. Profile changes are logged for security auditing.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-10">
                  ...
                  <div className="grid grid-cols-2 gap-12 pt-6">
                    <div className="space-y-2">
                      <p className="text-[8px] font-black text-slate-300 uppercase tracking-[0.4em]">Member Since</p>
                    ...
                    <div className="space-y-2">
                      <p className="text-[8px] font-black text-slate-300 uppercase tracking-[0.4em]">Access Level</p>
