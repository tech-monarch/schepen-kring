  ...
  const processSyncQueue = async () => {
    ...
    for (const action of queue) {
      try {
        ...
        console.error("Sync failed for task", action.id);
      }
    }
  ...
  const advanceStatus = async (
    ...
    if (type === "assigned") {
      ...
      localStorage.setItem(
        "personal_tasks",
        JSON.stringify(updatedTasks.filter((t) => t.type === "personal")),
      );
    }
  };
                  ...
                  <motion.div
                    ...
                    className={cn(
                      ...
                      task.status !== "Done" && task.priority === "High"
                        ...
                        : "border-slate-200 border-l-4 border-l-[#003566]",
                      task.status === "Done" &&
                    ...
                    <div className="flex items-center gap-6 flex-1 w-full">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3">
                          ...
                          {task.status !== "Done" &&
                            task.priority === "High" && (
                              <span className="px-2 py-0.5 bg-red-600 text-white text-[7px] font-black uppercase">
                                Urgent
                              </span>
                            )}
                        </div>
