...
// ============================================
// CALENDAR VIEW COMPONENT (same as admin)
// ============================================
...
export default function PartnerTasksPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Partner tasks via the unified /tasks endpoint (backend filters by role)
      const tasksRes = await axios.get(`${API_BASE}/tasks`, getHeaders());
      // Partner's employees via /partner/users
        ...
        >
          <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
              <div>
                <h1 className="text-4xl font-serif italic text-[#003566]">Partner Task Oversight</h1>
