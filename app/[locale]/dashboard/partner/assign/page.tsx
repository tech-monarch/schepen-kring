// app/[locale]/dashboard/partner/tasks/page.tsx
"use client";
...
// ============================================
// TASK MODAL COMPONENT (Partner Version)
// ============================================
...
export default function PartnerTasksPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Fetch partner's tasks using the partner tasks endpoint
      const tasksPromise = axios.get(`${API_BASE}/partner/tasks`, { headers });

      // Fetch users under this partner (employees, customers, sellers)
      const usersPromise = axios.get(`${API_BASE}/partner/users`, { headers });
  ...
  const handleTaskSubmit = async (taskData: any) => {
    try {
      ...
      if (editingTask) {
        // Update task via partner endpoint
        await axios.put(
          `${API_BASE}/partner/tasks/${editingTask.id}`,
          dataToSend,
          { headers },
        );
        toast.success("Task updated successfully");
      } else {
        // Create task via partner endpoint
        await axios.post(`${API_BASE}/partner/tasks`, dataToSend, { headers });
  ...
  const handleDeleteTask = async (taskId: number) => {
    ...
    try {
      ...
      await axios.delete(`${API_BASE}/partner/tasks/${taskId}`, { headers });
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      await axios.patch(
        `${API_BASE}/partner/tasks/${taskId}/status`,
        { status: newStatus },
        { headers },
      );
