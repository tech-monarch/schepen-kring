...
import {
  ...
  deleteAvatar,
  type Avatar,
} from "@/app/[locale]/actions/avatar";
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          className={`text-slate-600 text-sm leading-relaxed ${viewMode === "grid" ? "line-clamp-2" : "line-clamp-1"}`}
                        >
                          {avatar.description}
                        </p>
                      </div>
                      ...
                      <div
                        className={`${viewMode === "list" ? "flex items-center space-x-2" : "flex justify-center space-x-2 mt-4"}`}
                      >
                        <Link
