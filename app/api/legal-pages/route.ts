  ...
  en: [
    {
      ...
      content: `<h1>Privacy Policy</h1>
        ...
        <p>This Privacy Policy describes how Schepenkring.nl("we", "our", or "us") collects, uses, and shares your personal information when you use our service.</p>
    ...
    },
    {
      ...
      content: `<h1>Terms of Service</h1>
        ...
        <h2>Use License</h2>
        <p>Permission is granted to temporarily download one copy of Schepenkring.nlmaterials for personal, non-commercial transitory viewing only.</p>
        <h2>Disclaimer</h2>
        <p>The materials on Schepenkring.nlare provided on an 'as is' basis. Schepenkring.nlmakes no warranties, expressed or implied.</p>`,
      language: "en",
      last_updated_at: "2025-01-01T00:00:00Z",
      last_updated_by: "admin",
      is_active: true,
    },
    {
      ...
      content: `<h1>Cookie Policy</h1>
        <p>Last updated: January 1, 2025</p>
        <p>This Cookie Policy explains how Schepenkring.nluses cookies and similar technologies when you visit our website.</p>
  ...
  nl: [
    {
      ...
      content: `<h1>Privacybeleid</h1>
        ...
        <p>Dit Privacybeleid beschrijft hoe Schepenkring.nl("wij", "ons", of "onze") uw persoonlijke informatie verzamelt, gebruikt en deelt wanneer u onze service gebruikt.</p>
    ...
    },
    {
      ...
      content: `<h1>Algemene Voorwaarden</h1>
        <p>Laatst bijgewerkt: 1 januari 2025</p>
        <p>Lees deze Algemene Voorwaarden ("Voorwaarden") zorgvuldig door voordat u Schepenkring.nlgebruikt.</p>
        ...
        <p>Toestemming wordt verleend om tijdelijk één kopie van Schepenkring.nlmaterialen te downloaden voor persoonlijk, niet-commercieel tijdelijk bekijken alleen.</p>
        <h2>Disclaimer</h2>
        <p>De materialen op Schepenkring.nlworden geleverd op een 'zoals ze zijn' basis. Schepenkring.nlgeeft geen garanties, uitdrukkelijk of impliciet.</p>`,
      language: "nl",
      last_updated_at: "2025-01-01T00:00:00Z",
      last_updated_by: "admin",
      is_active: true,
    },
    {
      ...
      content: `<h1>Cookiebeleid</h1>
        <p>Laatst bijgewerkt: 1 januari 2025</p>
        <p>Dit Cookiebeleid legt uit hoe Schepenkring.nlcookies en vergelijkbare technologieën gebruikt wanneer u onze website bezoekt.</p>
